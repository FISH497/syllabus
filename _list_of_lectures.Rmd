...
intro <- list(
  title = "Introduction",
  topics = "Course overview; What is data science?; Types of questions; Storytelling",
  pdf = c(""),
...
analysis_steps <- list(
  ...
  topics = "Steps to an analysis; Informal vs formal analysis", "Rubrics",
  pdf = c(""),
...
organization_styles <- list(
  ...
  topics = "Organization & styles; Research compendia; Coding styles",
  pdf = c(""),
...
github <- list(
  ...
  topics = "Introduction to GitHub: Repositories, Markdown, Issues, Projects",
  pdf = c(""),
...
version_control <- list(
  ...
  topics = "Version control with Git: Adding, Committing, Reverting",
  pdf = c(""),
...
remotes <- list(
  ...
  topics = "Remotes in GitHub; RStudio projects; Pushing/pulling",
  pdf = c(""),
...
holiday_1 <- list(
  ...
  topics = c("** Martin Luther King, Jr. Day - No class **"),
  pdf = c(""),
  rmd = "",
  html = "",
  background = "",
...
workflows <- list(
  ...
  topics = "Understanding workflows: Centralized, Feature branch, Forking",
  pdf = c(""),
...
working_with_data <- list(
  ...
  topics = "Working with data: Chain of custody, Tidy data, Manual entry",
  pdf = c(""),
...
data_ingest <- list(
  title = "Getting data",
  topics = "Getting data: Importing text files, Reading from Excel & Google",
  pdf = c(""),
...
data_cleaning <- list(
  title = "Data cleaning",
  topics = "Data cleaning; Reshaping; Filtering; Summarizing",
  pdf = c(""),
  rmd = "",
  html = "",
  background = "",
...
getting_help <- list(
  title = "Getting help",
  topics = "Getting help; Creating a Minimal Reproducible Example (MRE)",
  pdf = c(""),
...
guest_woo <- list(
  ...
  topics = "Guest presentation: Kara Woo - Data science for fun and nonprofit",
  pdf = c(""),
  rmd = "",
...
databases_1 <- list(
  ...
  topics = "Introduction to relational databases",
  pdf = c(""),
...
databases_2 <- list(
  ...
  topics = "Creating a database; New users & databases; Adding data",
  pdf = c(""),
...
databases_3 <- list(
  ...
  topics = "Working with a database; Cleaning data; Joining tables",
  pdf = c(""),
...
review <- list(
  title = "Topic reviews",
  topics = "Review session; Workflows, Reprexes, Databases",
  pdf = c(""),
  rmd = "",
  html = "",
  background = "",
...
metadata <- list(
  title = "Metadata",
  topics = "Metadata, Ecological Metadata Language",
  pdf = c(""),
...
visualization <- list(
  ...
  topics = "Data visualization, Design principles, Exploratory figures, Expository figures",
  pdf = c(""),
  rmd = "",
  html = "",
  background = "",
...
analysis_visualization <- list(
  ...
  topics = "Data analysis & visualization: Data summaries, Design principles, Exploratory  & Expository figures",
  pdf = c(""),
...
holiday_2 <- list(
  ...
  topics = "** President's Day - No class **",
  pdf = c(""),
  rmd = "",
  html = "",
  background = "",
...
markdown_1 <- list(
  title = "R Markdown",
  topics = "R Markdown: Introduction, Publishing papers",
  pdf = c(""),
...
markdown_2 <- list(
  title = "R Markdown",
  topics = "R Markdown: Publishing papers, Reporting",
  pdf = c(""),
...
guest_stawitz <- list(
  ...
  topics = "Guest presentation: Dr. Christine Stawitz - Data science skills for a career in fisheries management",
  pdf = c(""),
  rmd = "",
...
packages_1 <- list(
  title = "R packages",
  topics = "Building R packages: Functions, Documentation",
  pdf = c(""),
...
packages_2 <- list(
  title = "R packages",
  topics = "Building R packages: Unit tests, Vignettes, Websites",
  pdf = c(""),
...
shiny_1 <- list(
  title = "Shiny apps",
  topics = "Introduction to Shiny apps",
  pdf = c(""),
...
markdown_3 <- list(
  title = "R Markdown",
  topics = "R Markdown: Designing presentations",
  pdf = c(""),
...
markdown_4 <- list(
  title = "R Markdown",
  topics = "R Markdown: Building simple websites",
  pdf = c(""),
...
code_reviews <- list(
  title = "Code reviews",
  topics = "Code reviews: Checklists, Do's and Don'ts",
  pdf = c(""),
